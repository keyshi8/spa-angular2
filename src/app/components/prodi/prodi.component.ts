...
export class ProdiComponent implements OnInit { // Mendeklarasikan class komponen dengan implementasi OnInit untuk inisialisasi.
  ...
  apiProdiUrl = 'https://express-nine-chi.vercel.app/api/prodi'; // URL API untuk mengambil dan menambahkan data prodi.
  apiFakultasUrl = 'https://express-nine-chi.vercel.app/api/fakultas'; // URL API untuk mengambil data fakultas.
  ...
  getProdiById(_id: string): void {
    this.editProdiId = _id; // Simpan ID Prodi yang akan diedit
